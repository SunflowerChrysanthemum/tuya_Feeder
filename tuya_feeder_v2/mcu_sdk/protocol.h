...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "c3wueodvvzgslg5w"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//剩余猫粮重量(只上报)
//备注:
#define DPID_TOTAL_WEIGHT 101
//盆余量(只上报)
//备注:
#define DPID_TUB_WEIGHT 102
//自动喂食(可下发可上报)
//备注:
#define DPID_SWITCH_AUTO 103
//小份喂食(只下发)
//备注:
#define DPID_SMALL_FEED 104
//中份喂食(只下发)
//备注:
#define DPID_MIDDLE_FEED 105
//大份喂食(只下发)
//备注:
#define DPID_BIG_FEED 106
